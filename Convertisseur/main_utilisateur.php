...
<html>
    ...
    <body>
			...
			<h1 Class="text-center" > Conversion d'un fichier .csv en fichier .xml</h1>
...
include_once("upload_csv_maquette_utilisateur.php"); // On inlue le code de conversion et de téléchargement du fichier xml
...
if(!isset($erreur)) //S'il n'y a pas d'erreur, on upload
{
     ...
     convertCsvToXmlFile($dossier_csv.$fichier);	 // On utilise le code pour convertir le fichier .csv, remettre "/var/www/html/upload_xml/output.xml"
